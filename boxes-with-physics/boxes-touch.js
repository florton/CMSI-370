(function ($) {
    ...
    var moveBoxes = function(box){
        if(box.context.movingBox !== undefined){
            ...
            //document.getElementById("console").innerHTML = "";
            //document.getElementById("console").appendChild(document.createTextNode( "("+target.gravityX+", "+ target.gravityY + ")"));
    ...
    window.ondevicemotion = function(event) {
        $("div.box").each(function (index) { 
            if($(this).context.movingBox !== undefined){
                ...
                //document.getElementById("console").innerHTML = "";
                //document.getElementById("console").appendChild(document.createTextNode( "("+target.offset().left+", "+ target.offset().top + ")"));
                
                if (target.offset().left < windowWidth-20 && event.accelerationIncludingGravity.x < 0 ){ 
                ...
                if (target.offset().top < windowHeight-20 && event.accelerationIncludingGravity.y > 0 ){ 
